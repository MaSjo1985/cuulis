...
<div class="cm8-half" style="padding-top: 20px">';
        ...
        while ($row2 = $result->fetch_assoc()) {
            ...
            $id = $row2[id];
            if ($kuvaus == '') {
                echo '<p style="font-weight: bold" >Haluatko todella poistaa valitsemasi linkin?</p>';
            } else {
                echo '<p><b>Haluatko todella poistaa linkin:<br><br></b> ' . $kuvaus . '?</p>';
            }
        }
        echo '<br><br><br><a href="poistalinkki.php?id=' . $id . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="linkit.php"  class="myButton9"  role="button"  style="margin-right: 30px">En</a><br>';
