...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    echo'<p style="font-weight: bold">Valitsemasi käyttäjät on nyt poistettu kurssilta/opintojaksolta.</p><a href="osallistujat.php"> <p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin';
} else {
