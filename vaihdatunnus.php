...
echo '<div class="cm8-container7"  style="padding-left: 20px; padding-top:0px" >';
        ...
        echo'<br><br><b>Cuulis-oppimisympäristön kirjautuminen on muuttunut.<br><br>Valitse itsellesi uusi käyttäjätunnus.</b><br>';
...
<div style="display: inline-block; color: red; font-weight: bold; padding-top: 0px" id="divID">
    <p class="eimitaan"></p>
		...
		<input type="button" id="button" onclick="validateFormTunnus(this)" value="&#10003 Tallenna" class="myButton9">
		</fieldset></form>';
