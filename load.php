...
if ($_SESSION["Rooli"] == 'opiskelija') {
    ...
    if ($kysakt == 0) {
        echo('<br><p style="font-weight: bold; color: #c7ef00">Toiminto ei ole aktiivinen, uusia kysymyksiä/kommentteja ei voi enää lähettää! </p><p>Voit sulkea näkymän oikean yläkulman painikkella.<br><br>');
    } else {
