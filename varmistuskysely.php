...
<head>
<title> Kyselylomakkeen poisto </title>';
...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo '<p style="font-weight: bold" >Haluatko todella poistaa kyselylomakkeen?</p>';


        echo '<br><a href="poistakysely.php" class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
