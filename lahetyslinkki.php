...
if (isset($_SESSION["Kayttajatunnus"]) && $_SESSION["Rooli"] == "opiskelija") {



    if ($_POST[kuvaus] != "") {
        $stmt = $db->prepare("INSERT INTO ryhmat2 (linkki, omatallennusnimi, projekti_id, tyonimi, ryhma_id) VALUES (?, ?, ?, ?, ?)");
