...
<div class="cm8-threequarter" style="padding-top: 20px">';

        if (!$result = $db->query("select * from aanestykset where id = '" . $_POST[aanid] . "'")) {
            die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="yhteydenotto.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
        }
        ...
        echo '<p style="font-weight: bold" >Haluatko todella poistaa valitsemasi äänestyksen?</p>';


        echo '<br><a href="poistaaanestys.php?id=' . $id . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="aanestykset.php?a=' . $_POST[aanid] . '"  class="myButton9"  role="button"  style="margin-right: 30px">En</a><br>';
