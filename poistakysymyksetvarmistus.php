...
<div class="cm8-half" style="padding-top: 0px">';
        ...
        echo '<br><br><br><a href="poistakysymykset.php?w1=' . $_POST[w1] . '&w2=' . $_POST[w2] . '&id=' . $_SESSION["KurssiId"] . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="kysymykset2.php?w1=' . $_POST[w1] . '&w2=' . $_POST[w2] . '"  class="myButton9"  role="button"  style="margin-right: 30px">En</a><br>
