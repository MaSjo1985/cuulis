...
while ($row8 = $result8->fetch_assoc()) {
    ...
    if ($_SESSION["Rooli"] == 'opettaja' || $_SESSION["Rooli"] == 'admin' || $_SESSION["Rooli"] == 'admink' || $_SESSION["Rooli"] == 'opeadmin' || $_SESSION["Rooli"] == 'opiskelija') {
        ...
        if ($_SESSION["Sallicd"] == 1) {
            ...
            if (date("Y-m-d H:i") > $koe) {
                ...
                echo'<div class="demo" data-date="' . $newDate . ' ' . $kello . '" style="height: 80px; text-align: center; display: inline-block "> </div>';
    ...
    echo'</div><div class="cm8-quarter" style="width: 5%; padding-right: 80px"><br></div><div class="cm8-quarter" style="width: 40px;"><br><a href="https://koulusafka.fi" target="_blank" onclick="koulusafka()"> <img src="/images/koulusafka.jpg" style="width: 40px;"></a><br></div></div>';
}