...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    echo "<b>Palautteesi on lähetetty!</b>";
    echo '<br><br><a href="kurssi.php?id=' . $_SESSION["KurssiId"] . '"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin</a>';
} else {
