...
if (isset($_SESSION["Kayttajatunnus"])) {
    ...
    echo'<p style="color: red" class="eimitaan">Huom! <br>Sallitun kuvatiedoston maksimikoko on 5,0 MB.<br>Sallittuja tiedostomuotoja ovat .jpg, .gif., .png ja .jpeg</p><br>
