    ...
    if ($_SESSION["Rooli"] == "opettaja" || $_SESSION["Rooli"] == "admin" || $_SESSION["Rooli"] == "admink" || $_SESSION["Rooli"] == "opeadmin") {
        ...
        if ($onkoprojekti->num_rows == 0) {
            ...
            while ($rowP = $onkoprojekti->fetch_assoc()) {
                ...
                echo'<p class="info" id="takas" style="color: #c7ef00" >Tehtäviä on yhteensä ' . $yht . ' kappaletta.</p>';
                ...
                echo'<form action="aktivoipisteytys.php" method="post" style="display:inline-block; margin-left: 20px"><input type="hidden" name="monesko" value=' . $monesko . '><input type="hidden" name="id" value=' . $ipid . '><input type="submit" name="painikea"  value="+ Ota tehtävien pisteytys käyttöön" title="+ Ota tehtävien pisteytys käyttöön" class="myButton8"  role="button"  style="padding:4px 6px; font-size: 0.9em"></form>';
                    ...
                    echo'<p class="info" style="color: #c7ef00"><b>Tehtävien yhteispistemäärä on ' . $pisteetyht . ' pistettä.</b></p>';
...
//              
                ...
                if ($suljettu == 0) {
                    ...
                    if (!empty($sulkeutuu) && $sulkeutuu != ' ') {
                        ...
                        echo'<p style="margin-bottom: 10px; font-weight: bold;color: #c7ef00;">Aseta tehtävien merkitsemiselle sulkeutumisajankohta: </p>';
...
//                                
            ...
            <input type="text" class="kdate" id="kdate' . $rowt[id] . '"  name="paiva" style="margin-right: 20px; width: 100px; font-size: 0.9em" value=' . $sulkeutumispaiva2 . '>';
                                        ...
                                        echo'<p style="display: inline-block; background-color: #ffb1e0"><b style="font-size:0.9em; margin-right: 20px">Aseta osiolle sulkeutumisajankohta: </b></p>';
                                        echo'<b style="font-size: 0.9em">Pvm:</b>
	...
	<input type="submit" style="margin-left: 20px; padding: 4px" value="Tallenna" class="myButton8" name="tallenna" id="button' . $otmaara . '" title="Tallenna takaraja">
                                    ...
                                    if ($automaattinen == 1) {
                                        ...
                                        echo'<p style="display: inline-block; background-color: #ffb1e0"><b style="font-size:0.9em; margin-left: 20px; margin-right: 20px">Aseta osiolle sulkeutumisajankohta: </b></p>';
                                        echo'<b style="font-size: 0.9em">Pvm:</b>
...
//
//
//                echo'<p style="margin-top: 0px">* <b>Taulukko tallentuu automaattisesti</b>, kun merkitset rastin kohtiin<br>"Osasin", "Tein, mutten osannut ilman apua", "Haluan käydä tunnilla läpi"</p>';
//
//                if ($itsepisteytys) {
...
//       
                ...
                if (!$esta) {
                    ...
                    if ($pisteet) {
                        if ($itsepisteytys) {
                            echo'<th>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Oma pisteytys<br>tehtävästä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti <br><br><input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButtonKom"  role="button" style="background-color: yellow; color: black; padding:4px 6px; font-size: 1em"></th><th style="border: none"></th></tr></thead><tbody>';
                        } else {
                            echo'<th>Tehtävä<th>Tehtävän<br>pistemäärä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti <br><br><input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButtonKom"  role="button"  style="background-color: yellow; color: black; padding:4px 6px; font-size: 1em"></th><th style="border: none"></th></tr></thead><tbody>';
                        }
                    } else {
                        ...
                        if ($itsepisteytys) {
                            ...
                            echo'<th>Tehtävä</th><th>Oma pisteytys<br>tehtävästä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti <br><br> <input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButtonKom"  role="button"  style="background-color: yellow; color: black; padding:4px 6px; font-size: 1em"></th><th style="border: none"></th></tr></thead><tbody>';
                        } else {
...
//                   echo'm: '.$monta;       
                        ...
                        if ($itsepisteytys) {
                            ...
                            if ($rowt[aihe] == 1 && $pisteet == 1) {
                                if ($rowt[aihekiinni] == 1) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0"><td style="border: 2px solid #080708; border-right: none"></td><td colspan="5" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio on suljettu</b></td><td style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708"></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $estaosio)) {
                                    ...
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0"><td style="border: 2px solid #080708; border-right: none"></td><td colspan="5" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br></td><td style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708"></td></tr>';
                                }
                            } else if ($rowt[aihe] == 1 && $pisteet == 0) {
                                if ($rowt[aihekiinni] == 1) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0" ><td style="border: 2px solid #080708; border-right: none"></td><td colspan="4" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio on suljettu</b></td><td style="background-color: #ffb1e0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $estaosio)) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0" ><td style="border: 2px solid #080708; border-right: none"></td><td colspan="4" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #ffb1e0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $osiovapaa)) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0" ><td style="border: 2px solid #080708; border-right: none"></td><td colspan="4" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio sulkeutuu: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #ffb1e0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
   ...
   WHERE itsetehtavat_id='" . $rowt[id] . "' AND kayttaja_id='" . $_SESSION["Id"] . "'
                            ...
                            if ($rowt[aihe] == 1 && $pisteet == 1) {
                                ...
                                if ($rowt[aihekiinni] == 1) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0" ><td style="border: 2px solid #080708; border-right: none"></td><td colspan="3" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio on suljettu</b></td><td style="background-color: #ffb1e0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $estaosio)) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0" ><td style="border: 2px solid #080708; border-right: none"></td><td colspan="3" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #ffb1e0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
                                } else if (($rowt[aihekiinni] == 0 && $osiovapaa)) {
                                    echo '<tr style=" font-size: 1em; background-color: #ffb1e0" ><td style="border: 2px solid #080708; border-right: none"></td><td colspan="3" style="background-color: #ffb1e0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none"><b>' . $rowt[otsikko] . '</b><br><br><b style="font-size:0.9em; margin-right: 20px; color: red">Tämä osio sulkeutuu: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</b></td><td style="background-color: #ffb1e0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
   ...
   WHERE itsetehtavat_id='" . $rowt[id] . "' AND kayttaja_id='" . $_SESSION["Id"] . "'
                ...
                //ESTETTY, PISTEET EI TOIMI, EI-PISTEET TOIMII!
                    ...
                    if ($pisteet) {
                        if ($itsepisteytys) {
                            echo'<th>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Oma pisteytys<br>tehtävästä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti</th><th style="border: none"></th></tr></thead><tbody>';
                        } else {
                        ...
                        if ($itsepisteytys) {
                            ...
                            echo'<th>Tehtävä</th><th>Oma pisteytys<br>tehtävästä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti</th><th style="border: none"></th></tr></thead><tbody>';
                        } else {
