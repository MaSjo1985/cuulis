...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo '<p style="font-weight: bold" >Haluatko todella poistaa aikataulun?</p>';


        echo '<br><a href="poista_aikataulu.php" class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="kurssi.php?id=' . $_SESSION[KurssiId] . '"  class="myButton9"  role="button" >En</a><br>';
