  ...
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        if (empty($_POST["lista10"])) {
            ...
            echo'<br><a href="lisaaopettajaeka.php"> <p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin';
        } else {
            $lista = $_POST["lista10"];
            $idt = $_POST["lista10"];


            echo '<p style="font-weight: bold" >Haluatko todella lisätä kurssille/opintojaksolle seuraavat opettajat?</p>';
            ...
            echo'<form action="lisaaopettaja.php" method="post">
