...
echo '<a href="etusivu.php"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa etusivulle</a><br><br><p style="color:#FF0000 ; font-size:1.1em">Valitse rooli! </p> <br><b>Kaikki tiedot ovat pakollisia.  <br><p style="color: #f7f9f7">Huom! Roolia ja ensisijaista oppilaitosta ei voi enää myöhemmin muuttaa!!</b></p><br>Vahvistustiedot lähetetään antamaasi sähköpostiosoitteeseen.<br><br>';
