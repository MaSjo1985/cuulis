...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo '<p style="font-weight: bold" >Haluatko todella poistaa Itsearviointilomakkeen?</p>';


        echo '<br><a href="poistaitsearviointi.php" class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
