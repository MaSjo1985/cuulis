...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo' <div class="cm8-third" ><h2>Keskustele</h2></div>';


        echo'<div class="cm8-twothird" style="padding-top: 0px">';

        echo '<p style="font-weight: bold" >Haluatko todella poistaa valitsemasi keskusteluviestin?</p>';


        echo '<br><br><br><a href="poistakeskusteluviestiyksilollinen.php?kesid=' . $_POST[kesid] . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="selvitakeskustelija.php?kesid=' . $_POST[kesid] . '&kaid=' . $_POST[kaid] . '" class="myButton9"  role="button" >En</a><br>';
