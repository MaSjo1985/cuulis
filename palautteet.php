...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo '<br><h7>KURSSIPALAUTTEET</h7>';
        echo '<a href="kurssi.php?id=' . $_SESSION["KurssiId"] . '"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin</a><br><br>';
        ...
        if ($haepalaute->num_rows != 0) {
            ...
            while ($rowp = $haepalaute->fetch_assoc()) {
                $maara++;
                echo "<br><br><b>Palaute " . $maara . ":</b><br><br>";

                $palaute = $rowp[sisalto];
                echo'<br>' . $palaute . '<br>';
                echo '<div class="cm8-margin-top"></div>';
                echo'<form action="poistapalautteetvarmistus.php" method="post">';
                echo'<input type="hidden" name="id" value=' . $rowp[id] . '><input type="submit" value="&#10007 Poista" class="myButton8"  role="button"  style="padding:2px 4px">
								';
                echo'</form>';
            ...
            echo "<br><br><br><br><em>Ei annettuja palautteita.<br><br>";
        }
    }
} else {
