...
<div class="cm8-half" style="padding-top: 20px">';
    ...
    if ($projekti->num_rows != 0) {
        ...
        echo' <h8>Muokkaa palauttamaasi tiedostoa. </h8> ';
        ...
        if (!$haetiedosto = $db->query("select * from ryhmat2 where id='" . $_GET["id"] . "'")) {
            die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
        }
        ...
        if ($linkki == 0) {
            ...
            echo'<p><b>Tiedoston nimi: </b><b style="color: #e608b8">*</b><br><br><textarea class="textarea" id="tyonimi" rows="1" name="tyonimi">' . $tyonimi . '</textarea><br></p>
    ...
    <p class="eimitaan" style="color: #e608b8; padding:0px; margin:0px"></p>
		...
		<br><br><input type="submit" class="myButton9" id="button1" value="&#10003 Tallenna">
	</fieldset></form>';
        } else {
            ...
            echo'<p><b>Tiedoston nimi: </b><b style="color: #e608b8">*</b><br> <textarea rows="1" class="textarea" name="kuvaus" id="tama1" >' . $tyonimi . ' </textarea></p>
...
<p><b>URL-osoite:</b>:<br> <textarea rows="1" class="textarea" id="osoite" name="osoite">' . $omatallennusnimi . '</textarea></p>
	<input type="hidden" name="pid" value=' . $pid . ' >
		<input type="hidden" name="ryid" value=' . $ryid . ' >
                           <input type="hidden" name="kaid" value=' . $_SESSION[Id] . ' >
                                           <input type="hidden" name="id" value=' . $id . ' >
		<br><br><input type="button" onclick="validateFormO()" id="button2" value="&#10003 Tallenna" class="myButton9">
