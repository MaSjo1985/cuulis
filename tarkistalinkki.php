...
if ($result23->num_rows != 0) {
    ...
    if ($result22->num_rows != 0 && $result24->num_rows != 0) {
        ...
        echo json_encode(array('status' => 'error', 'viesti' => 'linkki', 'lataa' => 'lataa', 'teksti' => $teksti));
    } else if ($result22->num_rows != 0 && $result24->num_rows == 0) {
        ...
        if ($maara == 1) {
            ...
            echo json_encode(array('status' => 'error', 'viesti' => 'linkki', 'lataa' => 'ei', 'teksti' => $teksti));
        } else {
