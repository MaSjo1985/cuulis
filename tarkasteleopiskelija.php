            ...
            if ($itsepisteytys) {
                ...
                if ($rowt[aihe] == 1 && $pisteet == 1) {
                    if ($rowt[aihekiinni] == 1) {
                        echo '<tr style=" font-size: 1em; background-color:#d0d0d0" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="5" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: #e608b8; font-weight: bold">Tämä osio on suljettu!</em></td><td style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708" class="stripe-2"></td></tr>';
                    } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt > $takaraja2))) {
                        echo '<tr style=" font-size: 1em; background-color:#d0d0d0" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="5" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: #e608b8; font-weight: bold">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</em></td><td class="stripe-2" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708"></td></tr>';
                    } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt <= $takaraja2))) {
                ...
                if ($rowt[aihe] == 1 && $pisteet == 1) {
                    ...
                    if ($rowt[aihekiinni] == 1) {
                        echo '<tr style=" font-size: 1em;" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="3" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: #e608b8; font-weight: bold">Tämä osio on suljettu!</em></td><td class="stripe-2" style="background-color:#d0d0d0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
                    } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt > $takaraja2))) {
                        echo '<tr style=" font-size: 1em; background-color:#d0d0d0" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="3" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: #e608b8; font-weight: bold">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</em></td><td style="background-color:#d0d0d0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 " class="stripe-2"></td></tr>';
                    } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt <= $takaraja2))) {
