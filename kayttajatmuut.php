...
<a href="kayttajatmuut.php" class="currentLink">Käyttäjät &nbsp<em style="font-size: 0.6em">(ylläpito)</em></a>
...
<a href="kayttajatvahvistus.php" >Vahvistusta odottavat käyttäjät</a> 
  ...
  <a href="kayttajatmuut.php" class="currentLink3">Muut käyttäjät</a>
...
//    }
        ...
        if ($_SESSION["Rooli"] == 'admin') {
            ...
            if ($_GET['field10'] == 'kirjautunut') {
                ...
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='muu' ORDER BY paiva $sort, kello")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            } else {
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='muu' ORDER BY $field10 $sort")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            }
            if ($result10->num_rows == 0)
                echo"<br><br>Ei muita käyttäjiä.<br>";
            else {
                echo '<form action="kayttajatmuut.php" method="get">

<br>&#128270 <input type="search"  onkeyup="showResult7(this.value)" name="search"  id="search_box" class="haku" style="width: 50%"> 
...
<ul id="results" class="update">
                ...
                if ($_GET[kaikki20] == 'joo') {

                    echo '<table id="mytable" class="cm8-striped cm8-uusitablekayttajat" style="table-layout:fixed; max-width: 100%; ">  <thead>';
                    echo '<tr><th><a href="kayttajatmuut.php?sorting0=' . $sort . '&kaikki20=joo&field20=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatmuut.php?sorting1=' . $sort . '&kaikki20=joo&field20=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatmuut.php?sorting2=' . $sort . '&kaikki20=joo&field20=sposti">Sähköpostiosoite &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatmuut.php?sorting3=' . $sort . '&kaikki20=joo&field20=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatmuut.php?sorting5=' . $sort . '&kaikki20=joo&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><th><a href="kayttajatmuut.php?kaikki20=ei" > Tyhjennä valinnat<br>&nbsp&#9661&nbsp</a></th><th>Lähetä viesti</th></tr>';
                    echo'</thead><tbody>';
                    ...
                    echo '<table id="mytable" class="cm8-striped cm8-uusitablekayttajat" style="table-layout:fixed; max-width: 100%; ">  <thead>';
                    echo '<tr><th><a href="kayttajatmuut.php?sorting0=' . $sort . '&field20=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatmuut.php?sorting1=' . $sort . '&field20=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatmuut.php?sorting2=' . $sort . '&field20=sposti">Sähköpostiosoite &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatmuut.php?sorting3=' . $sort . '&field20=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatmuut.php?sorting5=' . $sort . '&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><th><a href="kayttajatmuut.php?kaikki20=joo" > Valitse kaikki<br>&nbsp&#9661&nbsp</a></th><th>Lähetä viesti</th></tr>';
                    echo'</thead><tbody>';
            ...
            echo '<h3>Ylläpitämäsi oppilaitoksen ' . $koulu . ' muut käyttäjät:</h3>';
            echo'<p id="ohje">Klikkaamalla käyttäjän suku- tai etunimeä pääset tarkastelemaan käyttäjän profiilia ja muokkaamaan tietoja.</p>';
            ...
            if ($_GET['field10'] == 'kirjautunut') {
                ...
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='muu' ORDER BY paiva $sort, kello")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            } else {
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='muu' ORDER BY $field10 $sort")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            }
            if ($result10->num_rows == 0)
...
<ul id="results" class="update">
                ...
                if ($_GET[kaikki20] == 'joo') {
                    ...
                    echo '<table id="mytable" class="cm8-striped cm8-uusitablekayttajat" style="table-layout:fixed; max-width: 100%; ">  <thead>';
                    echo '<tr><th><a href="kayttajatmuut.php?sorting0=' . $sort . '&kaikki20=joo&field20=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatmuut.php?sorting1=' . $sort . '&kaikki20=joo&field20=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatmuut.php?sorting2=' . $sort . '&kaikki20=joo&field20=sposti">Sähköpostiosoite &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><th><a href="kayttajatmuut.php?sorting5=' . $sort . '&kaikki20=joo&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><a href="kayttajatmuut.php?sorting3=' . $sort . '&kaikki20=joo&field20=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatmuut.php?kaikki20=ei" > Tyhjennä valinnat<br>&nbsp&#9661&nbsp</a></th><th>Lähetä viesti</th></tr>';
                    echo'</thead><tbody>';
