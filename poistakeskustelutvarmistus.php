...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo '<p style="font-weight: bold" >Olet poistamassa kaikki lähetetyt keskusteluviestit.</p>';
        echo("<br>Haluatko jatkaa?");

        echo '<br><br><a href="poistakeskustelutkaikki.php?r=' . $_POST[id] . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="keskustelut.php?r=' . $_POST[id] . '"   class="myButton9"  role="button" >En</a><br>';
