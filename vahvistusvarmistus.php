    ...
    if ($_SESSION["Rooli"] == "admin" || $_SESSION["Rooli"] == "admink" || $_SESSION["Rooli"] == "opeadmin") {
        ...
        if (isset($_POST['painikep'])) {
            ...
            if (empty($_POST["lista8"])) {
                ...
                $lista = $_POST["lista8"];
                $idt = $_POST["lista8"];
                echo '<br><p style="font-weight: bold" >Haluatko todella hylätä seuraavien käyttäjien rekisteröitymisen?</p>';
                ...
                echo'<form action="hylkaarekisteroityminen.php" method="post">
                ...
                echo'<input type="hidden" name = "minne" value="vahvistus">';
        ...
        if (isset($_POST['painikev'])) {
            ...
            if (empty($_POST["lista8"])) {
                ...
                $lista = $_POST["lista8"];
                $idt = $_POST["lista8"];
                echo '<br><p style="font-weight: bold" >Haluatko todella vahvistaa seuraavien käyttäjien liittymisen Cuulis-oppimisympäristöön?</p>';
                ...
                echo'<form action="vahvistaope.php" method="post">
						 <input type="radio" name = "valinta" value="joo"> Kyllä <br>
					   <input type="radio" name = "valinta" value="ei" selected> En <br>';
