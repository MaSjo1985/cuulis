...
<div class="cm8-threequarter" style="padding-top: 0px; margin-top: 0px">';
        ...
        if (($suljettu == 0 && $takarajaon == 0) || ($takarajaon == 1 && $nyt < $takaraja && $suljettu == 0)) {
            ...
            if ($suljettu == 1) {
                echo'<p style="color: red; font-size: 1.1em" class="stripe-2"><b>Taulukon muokkausmahdollisuus on suljettu.</b></p>';
                $esta = true;
            } else if (($takarajaon == 1 && ($nyt >= $takaraja))) {

                echo'<p style="color: red; font-size: 1.1em" class="stripe-2"><b>Taulukon muokkausmahdollisuus on sulkeutunut <b>' . $sulkeutumispaiva . ' klo ' . $sulkeutumiskello . '</b></b></p>';
                $esta = true;
            }
        }
        ...
        if ($pisteet) {
            echo'<th>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti  <br><input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButton11"  role="button"  style="padding:4px 6px; background-color: #f7f9f7"></th><th style="border: 2px solid #f7f9f7; background-color:#f7f9f7"></th></tr></thead><tbody>';
        } else {
            echo'<th>Tehtävä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti <br><input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButton11"  role="button"  style="padding:4px 6px; background-color: #f7f9f7"></th><th style="border: 3px solid #f7f9f7; background-color:#f7f9f7; border-right: 5px solid #f7f9f7"></th></tr></thead><tbody>';
        }
   ...
   WHERE itsetehtavat_id='" . $rowt[id] . "' AND kayttaja_id=598
            ...
            if ($rowt[aihe] == 1 && $pisteet == 1) {
                if ($rowt[aihekiinni] == 1) {
                    echo '<tr style=" font-size: 1em; background-color:#d0d0d0" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="4" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: red; font-weight: bold">Tämä osio on suljettu!</em></td><td style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708" class="stripe-2"></td></tr>';
                } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt > $takaraja2))) {
                    echo '<tr style=" font-size: 1em; background-color:#d0d0d0" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="4" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: red; font-weight: bold">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</em></td><td class="stripe-2" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708"></td></tr>';
                } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt <= $takaraja2))) {
                ...
                if ($rowt[aihekiinni] == 1) {
                    echo '<tr style=" font-size: 1em;" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="3" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: red; font-weight: bold">Tämä osio on suljettu!</em></td><td class="stripe-2" style="background-color:#d0d0d0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 "></td></tr>';
                } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt > $takaraja2))) {
                    echo '<tr style=" font-size: 1em; background-color:#d0d0d0" class="stripe-2"><td style="border: 2px solid #080708; border-right: none" class="stripe-2"></td><td colspan="3" style="background-color:#d0d0d0; border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-left: none" class="stripe-2"><b>' . $rowt[otsikko] . '</b><br><em style="color: red; font-weight: bold">Tämä osio on sulkeutunut: ' . $sulkeutumispaiva2 . ', klo ' . $sulkeutumiskello2 . '</em></td><td style="background-color:#d0d0d0;  border-bottom: 2px solid #080708; border-top: 2px solid #080708; border-right: 2px solid #080708 " class="stripe-2"></td></tr>';
                } else if (($rowt[aihekiinni] == 0 && ($takaraja2 != '' && $nyt <= $takaraja2))) {
