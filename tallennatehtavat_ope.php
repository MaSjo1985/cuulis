...
//    $value3 = $lista3;
    if (isset($_POST[omat])) {
        $db->query("update itsetehtavatkp set opiskelijan_pisteet='" . $_POST[omat] . "' where itsetehtavat_id = '" . $value . "' AND kayttaja_id='" . $opid . "'");
    }
    if (isset($_POST[kommentti])) {
        $$_POST[kommentti] = nl2br($_POST[kommentti]);
        $db->query("update itsetehtavatkp set kommentti='" . $_POST[kommentti] . "' where itsetehtavat_id = '" . $value . "' AND kayttaja_id='" . $opid . "'");
    }
