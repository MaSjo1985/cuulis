...
if ($pisteet) {
    ...
    echo'<ul style="max-width: 99%; color:  #c7ef00"><li><b>Tehtäviä on yhteensä: </b>' . $yht . ' kpl.</li><li style="margin-left: 30px"><b>Tehtyjä tehtäviä: </b>' . $osuus . ' %.</li><li style="margin-left: 30px"><b>Kertoimet yhteensä: </b>' . $pisteetyht . ' p.</li></ul>';
} else {

    echo'<ul style="max-width: 99%; color:  #c7ef00"><li><b>Tehtäviä on yhteensä:</b> ' . $yht . ' kpl.</li><li style="margin-left: 30px"><b>Tehtyjä tehtäviä: </b>' . $osuus . ' %</li></ul>';
}
