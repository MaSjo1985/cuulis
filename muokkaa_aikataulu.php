...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        if ($onko != 0) {
            echo '<tr style="border-bottom: none"><td><button class="roskis" title="Poista" name="painikep"><i class="fa fa-trash-o" style="margin-right: 10px;"></i>Poista</button></td><td></td><td></td><td></td><td><input type="submit" name="painikel" value="+ Lisää rivi yläpuolelle" class="myButton8"  role="button"  ></td></tr>';
        } else {
        ...
        echo'<div style="text-align: center">';
        echo'<b style="margin-right: 40px; color:  #c7ef00">Voit myös valita, kuinka monta riviä haluat lisätä loppuun </b> <input type="number" name="tehtmaara" style="color: #080708; width: 60px" min="0">';
