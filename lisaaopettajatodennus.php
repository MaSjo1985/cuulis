...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo'<p style="color: #f7f9f7; font-weight: bold">Valitut opettajat on nyt lisätty kurssille/opintojaksolle ja heille on lähetetty tieto tästä sähköpostiin.</p>';
