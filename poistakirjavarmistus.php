...
function myFunction(y) {
  ...
  <br><br><p style="font-weight: bold" >Haluatko todella poistaa digikirjan kurssitehtäväsivulta?</p>';

    if ($_POST[paluu] == 'muokkaus') {
        echo '<br> <a href="poistakirja.php?i=' . $_POST[ipid] . '&paluu=muokkaus" class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="testaamuokkaus.php?id=' . $_POST[ipid] . '" class="myButton9"  role="button" >En</a><br>';
    } else {
        echo '<br> <a href="poistakirja.php?i=' . $_POST[ipid] . '" class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="itsetyot.php?i=' . $_POST[ipid] . '" class="myButton9"  role="button" >En</a><br>';
    }
