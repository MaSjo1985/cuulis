...
//        } else {
//
//            echo'<p style="z-index: 1;position: fixed; top:30%; right:10%"><form action="lisaakirja.php" style="z-index: 1;position: fixed; top:20%; left:2%" method="post" > <input type="hidden" name="ipid" value="' . $_GET[id] . '"><input type="hidden" name="paluu" value="muokkaus"> <input type="submit" value="+ Lisää digikirja"  class="myButton8"  role="button"  ></form></p>';
//        }
...
<div class="cm8-threequarter" style="padding-top: 0px; margin-top: 0px">';
        ...
        while ($rowP = $onkoprojekti->fetch_assoc()) {
            ...
            echo'<div  style="display: inline-block; width: 50%; margin-bottom: 20px; margin-left: 0px; padding-left: 0px">';


            echo'<br><b style="font-size: 0.9em">Pisteytetäänkö tehtävät?</b><br><br>';
            ...
            if ($result->num_rows != 0) {
                ...
                echo'<input type="radio" name="painotus" id="painotusok" value="1" checked><b style="font-size: 0.8em" > &nbsp&nbspKyllä</b><br>';
                echo'<input type="radio" name="painotus" id="idpainotusei" value="0"  > <b style="font-size: 0.8em" > &nbsp&nbspEi</b><br>';
            } else {
                echo'<input type="radio" name="painotus" id="painotusok" value="1"  ><b style="font-size: 0.8em" > &nbsp&nbspKyllä</b><br>';
                echo'<input type="radio" name="painotus" id="idpainotusei" value="0"   checked><b style="font-size: 0.8em" > &nbsp&nbspEi</b><br>';
            }
            ?>
                ...
                for (var i = 0; i < rad.length; i++) {
                    rad[i].onclick = function () {
                        ...
                        if (this.value == 0) {
                            ...
                            document.getElementById('annaomat').style.color = "#f7f9f7";
            ...
            echo'</div>';
            echo'<div id="annaomat" style="display: inline-block; width: 50%; margin-bottom: 20px; margin-left: 0px; padding-left: 0px">';
            echo'<p style="font-weight: bold; font-size: 0.9em">Annetaanko opiskelijoiden itse pisteyttää tekemänsä tehtävät?</p>';
  ...
  echo'<div id="scrollbar"><div id="spacer"></div></div>';
                    ...
                    if ($rowt[aihe] == 1) {
                        ...
                        if ($_GET[vikao] == 1) {
                            if (($_GET[monesko] == ($paluu)) && ($rowt[sisalto] == "") && ($rowt[otsikko] == "")) {
                                echo '<tr  class="taihe"><td ><input type="checkbox" name="lista[]" value=' . $rowt[id] . ' checked></td><td><textarea name="otsikko[]" class="content' . $maara . '" rows="4" style="height: 10px" autofocus>' . $rowt[otsikko] . '</textarea>';
                            } else {
                                echo '<tr  class="taihe"><td ><input type="checkbox" name="lista[]" value=' . $rowt[id] . ' checked></td><td><textarea name="otsikko[]" class="content' . $maara . '" rows="4" style="height: 10px">' . $rowt[otsikko] . '</textarea>';
                            }
                        } else {
                    ...
                    if ($rowt[aihe] == 1) {
                        ...
                        if ($_GET[vikat] == 1) {
                            if (($_GET[monesko] == ($paluu)) && ($rowt[sisalto] == "")) {
                                ...
                                echo '<tr id="' . $paluu . '" class="tsisalto"><td> <input type="checkbox" name="lista[]" value=' . $rowt[id] . '></td><td><textarea name="sisalto[]" rows="3" >' . $rowt[sisalto] . '</textarea></td><td style="text-align: center"><input type="number" name="paino[]" min="0" max="100"  value="' . $rowt[paino] . '"></td><td style="text-align: center"><input type="radio" name="jarjestys" value="' . $rowt[jarjestys] . '"></td></tr>';
                            }
                        } else {
            ...
            if ($onko != 0) {
                echo '<tr style="border:none;  background-color: transparent"><td style="border: 1.1px solid transparent"><button class="roskis" title="Poista" name="painikep"><i class="fa fa-trash-o" style="display: inline-block; margin-right: 10px"></i>Poista</button></td><td style="border: 1.1px solid transparent"></td><td style="border: 1.1px solid transparent"></td><td style="border: 1.1px solid transparent"><input type="hidden" name="ipid" value=' . $ipid . '> <input type="submit" name="painikelo" value="+ Lisää otsikko yläpuolelle" class="myButton8"  role="button"  ><br><input type="submit" name="painikel" value="+ Lisää tehtävä yläpuolelle" class="myButton8"  role="button"  ></td></tr>';
            } else {
                echo '<tr style="border: none;  background-color: transparent"><td></td><td></td><td></td><td><input type="hidden" name="ipid" value=' . $ipid . '><br> <input type="submit" name="painikelo" value="+ Lisää otsikko" class="myButton8"  role="button"  ><br><input type="submit" name="painikel" value="+ Lisää tehtävä" class="myButton8"  role="button"  ></td></tr>';
            }
