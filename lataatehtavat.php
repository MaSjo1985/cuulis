...
if ($rooli == "opettaja" || $rooli == "admin" || $rooli == "admink" || $rooli == "opeadmin") {
    ...
    while ($rowP = $onkoprojekti->fetch_assoc()) {
        ...
        if ($pisteet) {
            ...
            echo'<br><b  style="color: red">Huom! Vain osattujen tehtävien pisteet vaikuttavat edistymispylvääseen.</b><br><br>';
...
//       
        ...
        if (!$esta) {
            ...
            if ($pisteet) {
                echo'<th>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti &nbsp&nbsp&nbsp<input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButton11"  role="button"  style="padding:4px 6px; background-color: #f7f9f7"></th><th style="border: none"></th></tr></thead><tbody>';
            } else {
                echo'<th>Tehtävä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti&nbsp&nbsp&nbsp <input type="submit" name="painiket" value="&#10003 Tallenna kommentit" class="myButton11"  role="button"  style="padding:4px 6px; background-color: #f7f9f7"></th><th style="border: none"></th></tr></thead><tbody>';
            }
