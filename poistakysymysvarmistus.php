...
<div class="cm8-half" style="padding-top: 0px">';
        ...
        echo '<p style="font-weight: bold" >Haluatko todella poistaa valitsemasi kysymyksen?</p>';



        echo '<br><br><br><a href="poistakysymysyksilollinen.php?w1=' . $_POST[w1] . '&w2=' . $_POST[w2] . '&kysid=' . $_POST[kysid] . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="selvitakysyja.php?w1=' . $_POST[w1] . '&w2=' . $_POST[w2] . '&kysid=' . $_POST[kysid] . '&kaid=' . $_POST[kaid] . '" class="myButton9"  role="button" >En</a><br>
