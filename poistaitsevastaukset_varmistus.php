...
<head>
<title> Itsearviointilomakkeen vastausten poisto </title>';
...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        echo '<p style="font-weight: bold" >Haluatko todella poistaa annetut itsearviointilomakkeen vastaukset?</p>';


        echo '<br><a href="poistaitsevastaukset.php" class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="tarkastelearvioinnit.php" class="myButton9"  role="button"  style="margin-right: 30px">En</a><br>';
