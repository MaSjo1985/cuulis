...
<title>Lataa Cuulis-sovellus Androidille</title>
...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    echo'<meta name="description" content="Cuulis on eriasteisille oppilaitoksille suunnattu oppimisympäristö."/>
...
echo"<h7>Lataa Cuulis-sovellus puhelimeesi</h7>";
if (isset($_SESSION[KurssiId])) {

    echo'<br><a href="kurssi.php?id=' . $_SESSION[KurssiId] . '"><b><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa kurssin/opintojakson etusivulle</a></b>';
} else {

    echo'<br><a href="etusivu.php"><b><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa etusivulle</a></b>';
}
echo'<div class="cm8-margin-top"></div>';

echo'<br><p style="font-size: 1em; color: #c7ef00; font-weight: bold; padding-bottom: 20px">Huom! Koska lataat sovelluksen tältä sivulta, niin voit joutua vaihtamaan suojausasetuksia puhelimestasi ennen kuin voit asentaa sovelluksen.</p>';
