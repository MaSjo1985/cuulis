...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    echo '<div class="cm8-container3" style="margin-left: 20px; margin-top:20px">';


    echo "<b>Viestisi on lähetetty!</b>";
    echo ' <br><br><a href="osallistujat.php" class="palaa">&#8630 &nbsp&nbsp&nbspPalaa takaisin tästä </a>';
    echo "</div>";
} else {
