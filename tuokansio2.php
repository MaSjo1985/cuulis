...
if (isset($_SESSION["Kayttajatunnus"])) {
    if ($_SESSION["Rooli"] == "opettaja" || $_SESSION["Rooli"] == "admin" || $_SESSION["Rooli"] == "admink" || $_SESSION["Rooli"] == "opeadmin") {
	 ...
	 <a href="kurssi.php?id=' . $_SESSION["KurssiId"] . '">Etusivu</a><a href="tiedostot.php"  class="currentLink">Materiaalit</a>  
	  ...
	  <a href="itsetyot.php" onclick="loadProgress()" >Tehtävälista</a><a href="ryhmatyot.php" >Kurssityöt</a><a href="itsearviointi.php" >Itsearviointi</a><a href="kysely.php"  >Kyselylomake</a>
    ...
    <div id="content" class="cm8-twothird" style="padding-left: 20px; margin-right: 0px; margin-top: 40px; margin-bottom: 0px; padding-bottom: 10px">';
        ...
        if ($haetiedostot->num_rows == 0) {
          ...
          echo'<p id="ohje"><b style="font-size: 1.1em">Kurssille ei ole lisätty kansioita.</b></p>';
            ...
            $numeric1 = 0;
            $numeric3 = 0;
            while ($rowekak = $haetiedostot->fetch_assoc()) {
                $id = $rowekak[id];
                $nimi = $rowekak[nimi];
                if (is_numeric($rest = substr($nimi, 0, 1))) {
            ...
            if ($numeric1 == 1) {
                ...
                if ($numeric3 == 1) {
                    ...
                    if (!$haetiedostot = $db->query("select distinct * from kansiot where kurssi_id='" . $_GET[id] . "' order by  SUBSTR(nimi FROM 1 FOR 1),
    CAST(SUBSTR(nimi FROM 3) AS UNSIGNED)")) {
                        die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                    }
                } else {
                    if (!$haetiedostot = $db->query("select distinct * from kansiot where kurssi_id='" . $_GET[id] . "' order by cast(nimi as unsigned) asc")) {
                        die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                    }
                }
            } else {
                if (!$haetiedostot = $db->query("select distinct * from kansiot where kurssi_id='" . $_GET[id] . "' order by nimi")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            }
            ...
            echo'<div class="cm8-margin-top"></div>';
            echo'<form action="tuokansio3.php" method="get">';
            echo'<div class="cm8-responsive">';
            echo '<table class="cm8-table cm8-bordered cm8-stripedeivikaa">';

            if ($_GET[kaikki2] == joo) {
                echo '<tr style="font-size: 1.1em; border: 1px solid grey; background-color: #48E5DA"><th><a href="tuokansio2.php?id=' . $_GET[id] . '&kid=' . $_GET[kid] . '"  style="font-weight: bold; font-size: 0.8em"> Tyhjennä valinnat<br>&nbsp&#9661&nbsp</a></th><th>Kansio</th></tr>';
                ...
                while ($rowP2 = $haetiedostot->fetch_assoc()) {
                    ...
                    echo'<td><label for=' . $ipiduusi . '> ' . $rowP2[nimi] . '</label></td></tr>';
                ...
                echo '<tr style="font-size: 1.1em; border: 1px solid grey; background-color: #48E5DA"><th><a href="tuokansio2.php?id=' . $_GET[id] . '&kid=' . $_GET[kid] . '&kaikki2=joo" style="font-weight: bold; font-size: 0.8em"> Valitse<br>kaikki<br>&nbsp&#9661&nbsp</a></th><th>Kansio</th></tr>';
