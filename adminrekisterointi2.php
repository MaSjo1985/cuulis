...
if (isset($_SESSION["Kayttajatunnus"])) {
    ...
    echo'<br>Ylläpitäjän lisääminen onnistui!<br><br><a href="muokkaakoulu.php?id=' . $_GET[koid] . '"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin </a>';
