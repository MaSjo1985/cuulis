...
</a><a href="bugi.php" class="cm8-linkk3-valittu" title="Löytyikö virheitä/onko kehitysideoita?" >🙋 &nbsp Kehitysideoita?</a><a href="ulos.php" class="cm8-linkk3" title="Kirjaudu ulos">Kirjaudu ulos &nbsp&nbsp <i class="fa fa-sign-out" style="font-size: 1.2em"></i>
</a></p>';
...
<br><p><b> Viesti: </b><br><br><textarea name="viesti" style="width: 80%" rows="8"></textarea> </p><br><br> 
  	...
  	<input type="button" onclick="validateForm2()" value="📧 &nbsp  Lähetä" style="padding-bottom: 5px"  >
