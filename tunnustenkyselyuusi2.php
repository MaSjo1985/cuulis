...
echo'<br><p class="eimitaan" style="font-size: 1em">Lähetä sähköpostia koulun '.$koulu.' ylläpitäjälle '.$nimi.' osoitteeseen &nbsp&nbsp <u> <a class="osoite" href="mailto: '.$sposti.'">'.$sposti.' </a></u> &nbsp&nbsp ja pyydä häneltä käyttäjätunnusta ja salasanaa </p>
<br>
 </fieldset></form>';
