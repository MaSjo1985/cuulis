...
function myFunction(y) {
  y.classList.toggle("change");
    ...
    <p class="eimitaan"></p>
        ...
        echo'
	<br><br><p style="width: 100%">Kuvaus: <b style="color: red">*</b><br> <textarea class="textarea" rows="1" name="kuvaus" id="tama1" style="width: 40%">' . $osoite . '</textarea>
...
<input type="hidden" name="id" value=' . $id . ' ><br>
    ...
    <p style="padding:0px; margin:0px" id="demo2" class="eimitaan"></p>
        ...
        echo'
	<br><br><p style="width: 100%">Kuvaus:<b style="color: red">*</b><br> <textarea class="textarea" name="kuvaus" id="tama2" rows="1">' . $osoite . '</textarea>';
    ...
    <p style="padding:0px; margin:0px" id="demo3" class="eimitaan"></p>
        ...
        echo'
	<br><br><p style="width: 100%">Kuvaus: <b style="color: red">*</b><br> <textarea class="textarea"  rows="1" name="kuvaus" id="tama3">' . $osoite . '</textarea>';
