...
<a href="kayttajatopiskelijat.php" class="currentLink">Käyttäjät &nbsp<em style="font-size: 0.6em">(ylläpito)</em></a>
...
$start_from = ($page-1) * $results_per_page;
        if ($_SESSION["Rooli"] == 'admin') {
            ...
            if ($_GET['field10'] == 'kirjautunut') {
                ...
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND  rooli='opiskelija' ORDER BY paiva $sort, kello LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            } else {
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND  rooli='opiskelija' ORDER BY $field10 $sort LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            }
            if ($result10->num_rows == 0)
                ...
                echo '<form action="kayttajatopiskelijat.php" method="get">

<br>&#128270 <input type="search"  onkeyup="showResult6(this.value)" name="search"  id="search_box" class="haku" style="width: 50%"> 
...
<ul id="results" class="update">
                ...
                if ($_GET[kaikki2] == 'joo') {
                    ...
                    echo '<tr><th><a href="kayttajatopiskelijat.php?sorting0=' . $sort . '&kaikki2=joo&field2=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting1=' . $sort . '&kaikki2=joo&field2=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting2=' . $sort . '&kaikki2=joo&field2=sposti">Käyttäjätunnus &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting3=' . $sort . '&kaikki2=joo&field2=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting5=' . $sort . '&kaikki2=joo&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><th><a href="kayttajatopiskelijat.php?kaikki2=ei" > Tyhjennä valinnat<br>&nbsp&#9661&nbsp</a></th></tr>';
                    echo'</thead><tbody>';
                    ...
                    echo '<table id="mytable" class="cm8-striped cm8-uusitablekayttajat" style="table-layout:fixed; max-width: 100%; ">  <thead>';
                    echo '<tr><th><a href="kayttajatopiskelijat.php?sorting0=' . $sort . '&field2=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting1=' . $sort . '&field2=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting2=' . $sort . '&field2=sposti">Käyttäjätunnus &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting3=' . $sort . '&field2=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting5=' . $sort . '&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><th><a href="kayttajatopiskelijat.php?kaikki2=joo" > Valitse kaikki<br>&nbsp&#9661&nbsp</a></th></tr>';
                    echo'</thead><tbody>';
    ...
    if (!$result = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND  rooli='opiskelija' ORDER BY paiva $sort, kello")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
$yht = $result->num_rows;
...
for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
  ...
  echo'</div>';
            ...
            while ($row102 = $haekoulu->fetch_assoc()) {
                $koulu = $row102[Nimi];
            }
            echo '<h3>Ylläpitämäsi oppilaitoksen ' . $koulu . ' opiskelijat:</h3>';
            echo'<p id="ohje">Klikkaamalla käyttäjän suku- tai etunimeä pääset tarkastelemaan käyttäjän profiilia ja muokkaamaan tietoja.</p>';
            ...
            if ($_GET['field10'] == 'kirjautunut') {
                ...
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND  rooli='opiskelija' ORDER BY paiva $sort, kello LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            } else {
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND  rooli='opiskelija' ORDER BY $field10 $sort LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            }
            if ($result10->num_rows == 0)
...
<ul id="results" class="update">
                ...
                if ($_GET[kaikki2] == 'joo') {
                    ...
                    echo '<table id="mytable" class="cm8-striped cm8-uusitablekayttajat" style="table-layout:fixed; max-width: 100%; ">  <thead>';
                    echo '<tr><th><a href="kayttajatopiskelijat.php?sorting0=' . $sort . '&field2=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting1=' . $sort . '&field2=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting2=' . $sort . '&field2=sposti">Käyttäjätunnus &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatopiskelijat.php?sorting3=' . $sort . '&field2=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a><th><a href="kayttajatopiskelijat.php?sorting5=' . $sort . '&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th></th><th><a href="kayttajatopiskelijat.php?kaikki2=joo" > Valitse kaikki<br>&nbsp&#9661&nbsp</a></th></tr>';
                    echo'</thead><tbody>';
                ...
                echo'</form></div>';
                    echo'<div class="cm8-responsive" id="piilota2"  style="margin: 0px; padding: 0px; overflow: hidden">';
                    echo'<p style="font-weight: bold">Siirry muille sivuille: </p>';
  if (!$result = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND rooli='opiskelija' ORDER BY paiva $sort, kello")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
$yht = $result->num_rows;
$total_pages = ceil($yht / $results_per_page); // calculate total pages with results
