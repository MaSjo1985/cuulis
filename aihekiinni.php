        ...
        if ($onkoprojekti->num_rows == 0) {
            ...
            while ($rowP = $onkoprojekti->fetch_assoc()) {
                ...
                if ($pisteet) {
                    ...
                    echo'<table  style="border: 1px solid #080708; display: inline-block; margin-bottom: 40px; margin-right: 60px; padding: 0px 10px 0px 10px">';
    ...
    //opiskelija
        ...
        if (!isset($_GET[i]) || empty($_GET[i])) {
            ...
            while ($rowP = $onkoprojekti->fetch_assoc()) {
                ...
                echo'<br><h6 style="padding-bottom: 10px; font-size: 1.2em; color: #f7f9f7; display: inline-block">' . $kuvaus . '</h6><br><br>';
...
//       
                ...
                if (!$esta) {
                    echo'<br><p id="ohje" style="color: red; font-weight: bold; font-size: 1.1em">Huom! Muista painaa Tallenna-nappia, kun teet muutoksia!</p>';
                    ...
                    if ($pisteet) {
                        echo'<th><input type="submit" name="painiket" value="&#10003 Tallenna" class="myButton9"  role="button"  style="padding:4px 6px; background-color: #f7f9f7"><br>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti</th><th style="border: 2px solid #f7f9f7; background-color:#f7f9f7"></th></tr></thead><tbody>';
                    } else {
                        echo'<th><input type="submit" name="painiket" value="&#10003 Tallenna" class="myButton9"  role="button"  style="padding:4px 6px; background-color: #f7f9f7"><br>Tehtävä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti</th><th style="border: 3px solid #f7f9f7; background-color:#f7f9f7; border-right: 5px solid #f7f9f7"></th></tr></thead><tbody>';
                    }
...
//                                   
                    ...
                    echo '<tr style="border: 2px solid #080708; background-color: #48E5DA;  font-size: 1em">';
                    if ($pisteet) {
                        echo'<th>Tehtävä</th><th>Tehtävän<br>pistemäärä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti</th><th style="border: 2px solid #f7f9f7; background-color:#f7f9f7"></th></tr></thead><tbody>';
                    } else {
                        echo'<th>Tehtävä</th><th>Osasin</th><th>Tein,<br>mutten osannut<br>ilman apua</th><th>Haluan käydä<br>tunnilla läpi</th><th style="padding-top: 10px">Kommentti</th><th style="border: 3px solid #f7f9f7; background-color:#f7f9f7; border-right: 5px solid #f7f9f7"></th></tr></thead><tbody>';
                    }
