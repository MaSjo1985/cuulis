...
<div class="cm8-half" style="padding-top: 0px">';
        ...
        echo'<br><br><a href="valitsekysymykset.php?w1=' . $_GET[w1] . '&w2=' . $_GET[w2] . '"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin</a>';
        echo'</div>
