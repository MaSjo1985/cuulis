  ...
  y.classList.toggle("change");
    ...
    if (x.className === "topnav") {
        ...
        if (empty($_POST["lista"])) {
            ...
            echo'<br><br><a href="osallistujat.php"> <p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin';
        } else {
            $lista = $_POST["lista"];
            $idt = $_POST["lista"];


            echo '<p style="font-weight: bold" >Haluatko todella poistaa kurssilta/opintojaksolta seuraavat opiskelijat?</p>';
            ...
            echo'<form action="poistakurssilta.php" method="post">
