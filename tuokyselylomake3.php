...
<head>
<title> Kyselylomakkeen muokkaus</title>
...
<div class="cm8-twothird" style="padding-top: 0px; margin-top: 0px">';
        ...
        echo'<a href="tuokyselylomake.php"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> Palaa takaisin</a><br><br>';

        echo'<div class="cm8-margin-top"></div>';



        if (!$haeuusiprojekti = $db->query("select * from kyselyt where kurssi_id='" . $_GET[id] . "'")) {
            die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
        }
        if ($haeuusiprojekti->num_rows == 0) {

            echo'<br><em>Kurssilla ei ole valmista kyselylomaketta.</em><br>';
        } else {




            echo'<form action="tuokyselylomake2.php" method="post">';
            ...
            if (!$haetehtavat = $db->query("select distinct * from kyselyt where kurssi_id='" . $_GET[id] . "' ORDER BY jarjestys")) {
                die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
            }
