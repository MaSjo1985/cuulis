...
';
 ...
 <div class="cm8-margin-top"></div></div>';
    ...
    echo "<b>Viestisi on lähetetty!</b>";
    echo '<br><br><a href="ryhmatyot.php?r=' . $_GET[id] . '"><p style="font-size: 1em; display: inline-block; padding:0; margin: 0px 20px 0px 0px">&#8630</p> &nbsp&nbsp&nbsp Palaa takaisin</a>';
} else {
