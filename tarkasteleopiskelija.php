...
';
    ...
    echo'<div class="cm8-margin-top"></div>';
        ...
        if (($suljettu == 0 && $takarajaon == 0) || ($takarajaon == 1 && $nyt < $takaraja && $suljettu == 0)) {
            ...
            if ($suljettu == 1) {
                echo'<p style="color: #c7ef00; font-size: 1.1em" ><b>Taulukon muokkausmahdollisuus on suljettu.</b></p>';
                $esta = true;
            } else if (($takarajaon == 1 && ($nyt >= $takaraja))) {

                echo'<p style="color: #c7ef00; font-size: 1.1em" ><b>Taulukon muokkausmahdollisuus on sulkeutunut <b>' . $sulkeutumispaiva . ' klo ' . $sulkeutumiskello . '</b></b></p>';
                $esta = true;
            }
        }
        ...
        echo'<thead>';
        echo '<tr style="border: 2px solid #080708; background-color: #c50076;  font-size: 1em" id="palaatanne">';
