...
//                            }
        ...
        if ($onkokansio->num_rows == 0) {
            echo'<br><em id="ohje">Ei materiaaleja.</em>';
        } else {
    ...
    if ($haetiedostot->num_rows == 1) {
        ...
        if ($ekatiedosto) {
            echo'<p style="color: #c7ef00; font-weight: bold">Jos tiedosto ei aukea automaattisesti, niin tarkista, että selaimen ponnahdusikkunat on sallittu.</p>';
