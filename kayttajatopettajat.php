...
<a href="kayttajatopettajat.php" class="currentLink">Käyttäjät &nbsp<em style="font-size: 0.6em">(ylläpito)</em></a>
...
$start_from = ($page-1) * $results_per_page;
        ...
        if ($_SESSION["Rooli"] == 'admin') {
            ...
            if ($_GET['field10'] == 'kirjautunut') {
                ...
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='opettaja' ORDER BY paiva $sort, kello LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            } else {
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='opettaja' ORDER BY $field10 $sort LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            }
            if ($result10->num_rows == 0)
                echo"<br><br>Ei opettajia.<br>";
            else {
                echo '<form action="kayttajatopettajat.php" method="get">

<br>&#128270 <input type="search"  onkeyup="showResult5(this.value)" name="search"  id="search_box" class="haku" style="width: 50%"> 
...
<ul id="results" class="update">
                ...
                if ($_GET[kaikki] == 'joo') {
                    ...
                    echo '<tr><th><a href="kayttajatopettajat.php?sorting0=' . $sort . '&kaikki=joo&field=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatopettajat.php?sorting1=' . $sort . '&kaikki=joo&field=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatopettajat.php?sorting2=' . $sort . '&kaikki=joo&field=sposti">Sähköpostiosoite &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatopettajat.php?sorting3=' . $sort . '&kaikki=joo&field=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatopettajat.php?sorting5=' . $sort . '&kaikki=joo&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><th><a href="kayttajatopettajat.php?kaikki=ei" > Tyhjennä valinnat<br>&nbsp&#9661&nbsp</a></th><th>Lähetä viesti</th></tr>';
                    echo'</thead><tbody>';
                    ...
                    echo '<table id="mytable" class="cm8-striped cm8-uusitablekayttajat" style="table-layout:fixed; max-width: 100%; ">  <thead>';
                    echo '<tr><th><a href="kayttajatopettajat.php?sorting0=' . $sort . '&field=sukunimi">Sukunimi &nbsp&nbsp&nbsp' . $nuoli0 . ' </a></th><th><a href="kayttajatopettajat.php?sorting1=' . $sort . '&field=etunimi">Etunimi &nbsp&nbsp&nbsp' . $nuoli1 . ' </a></th><th><a href="kayttajatopettajat.php?sorting2=' . $sort . '&field=sposti">Sähköpostiosoite &nbsp&nbsp&nbsp' . $nuoli2 . ' </a></th><th><a href="kayttajatopettajat.php?sorting3=' . $sort . '&field=Nimi">Oppilaitos &nbsp&nbsp&nbsp' . $nuoli3 . ' </a></th><th><a href="kayttajatopettajat.php?sorting5=' . $sort . '&field10=kirjautunut">Kirjautunut viimeksi &nbsp&nbsp&nbsp' . $nuoli5 . ' </a></th><th><a href="kayttajatopettajat.php?kaikki=joo" > Valitse kaikki<br>&nbsp&#9661&nbsp</a></th><th>Lähetä viesti</th></tr>';
                    echo'</thead><tbody>';
                    while ($row10 = $result10->fetch_assoc()) {
                        if ($row10[paiva] != "0000-00-00" && $row10[paiva] !== null) {
                            $row10[paiva] = date("d.m.Y", strtotime($row10[paiva]));
...
for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
              if($i==$page) {
        echo '<a style="margin-right: 10px" href="kayttajatopettajat.php?page='.$i.'"><u>'.$i.'</u> </a>';
    }
    else{
        echo '<a  style="margin-right: 10px" href="kayttajatopettajat.php?page='.$i.'">'.$i.' </a>';
    } 
}; 
  echo'</div>';
            ...
            echo '<h3>Ylläpitämäsi oppilaitoksen ' . $koulu . ' opettajat:</h3>';
            echo'<p id="ohje">Klikkaamalla käyttäjän suku- tai etunimeä pääset tarkastelemaan käyttäjän profiilia ja muokkaamaan tietoja.</p>';
            ...
            if ($_GET['field10'] == 'kirjautunut') {
                ...
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='opettaja' ORDER BY paiva $sort, kello LIMIT $start_from, $results_per_page")) {
                    die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                }
            } else {
                if (!$result10 = $db->query("select distinct paiva, kello, sukunimi, etunimi, sposti, Nimi, kayttajat.id as kaid from kayttajat, koulut, kayttajankoulut where koulut.id='" . $_SESSION["kouluId"] . "' AND kayttajankoulut.odottaa=1 AND kayttajat.id=kayttajankoulut.kayttaja_id AND koulut.id=kayttajankoulut.koulu_id AND kayttajat.tarkistettu=1 AND kayttajat.vahvistettu=1 AND  rooli='opettaja' ORDER BY $field10 $sort LIMIT $start_from, $results_per_page")) {
