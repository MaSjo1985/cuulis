...
<title> Rekisteröitymisen hylkäys</title>';
...
if (isset($_SESSION["Kayttajatunnus"])) {
    ...
    if ($_POST["valinta"] == "ei")
        ...
        foreach ($lista as $tuote) {
            ...
            $otsikko = "Rekisteröitymisesi Cuulis-oppimisympäristöön on hylätty";
            $otsikko = "=?UTF-8?B?" . base64_encode($otsikko) . "?=";
            if ($_SESSION[Rooli] != 'admin') {
                $viesti = 'Rekisteröitymisesi Cuulis-oppimisympäristöön on hylätty.<br><br>Tämän syytä voit tiedustella ylläpitäjältä ' . $etunimi . ' ' . $sukunimi . ', ' . $spostia . '<br><br><em>Tähän viestiin ei voi vastata.</em>';
            } else {
                $viesti = 'Rekisteröitymisesi Cuulis-oppimisympäristöön on hylätty.<br><br>Tämän syytä voit tiedustella Cuulis-oppimisympäristön ylläpitäjältä ' . $etunimi . ' ' . $sukunimi . ', ' . $spostia . '<br><br><em>Tähän viestiin ei voi vastata.</em>';
            }
        ...
        header("location: hylkaarekisteroityminen2.php");
    }
