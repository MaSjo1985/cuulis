  ...
  y.classList.toggle("change");
    ...
    CAST(SUBSTR(nimi FROM 3) AS UNSIGNED)")) {
     ...
     <div id="content" class="cm8-twothird" style="padding-left: 20px; margin-right: 0px; margin-top: 40px; margin-bottom: 0px; padding-bottom: 10px">';
        ...
        echo'<p  style="font-weight: bold">Haluatko todella poistaa kurssin/opintojakson kaikki kansiot?</p>';

        if (!$result = $db->query("select distinct * from kansiot where kurssi_id = '" . $_POST[id] . "'")) {
            die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
        }
        ...
        while ($row2 = $result->fetch_assoc()) {
            ...
            while ($row3 = $result3->fetch_assoc()) {
                ...
                $linkki = $row3[linkki];
                if ($tuotu == 0 && $linkki == 0) {
                    if (!$result2 = $db->query("select distinct * from tiedostot where nimi = '" . $tnimi . "' AND tuotu=1 AND linkki=0")) {
                        die('<br><br><b style="font-size: 1em; color: #FF0000">Tietokantayhteydessä ongelmia!<br><br> Ota yhteyttä oppimisympäristön ylläpitäjään <a href="bugi.php" style="text-decoration: underline"><u>tästä.</b></u><br><br></div></div></div></div><footer class="cm8-containerFooter" style="padding: 20px 0px 20px 0px"><b>Copyright &copy;  <br><a href="admininfo.php">Marianne Sjöberg</b></a></footer>');
                    }
//                    if ($result2->num_rows > 1) {
//                        echo'<br><br><b style="color: #c7ef00">Huom! Kansion tiedosto <b style="color: #080708">"' . $nimi . '"</b> on tuotu myös muiden kurssien </b><br>';
...
//                    }
        ...
        echo '<br><a href="poistakaikkikansiot.php?id=' . $_POST[id] . '"  class="myButton9"  role="button"  style="margin-right: 30px">Kyllä</a>';
        echo '<a href="tiedostot.php"  class="myButton9"  role="button" >En</a><br>';
